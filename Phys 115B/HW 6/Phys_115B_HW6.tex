...
\section*{6 HD (part b could change)}
\begin{ques}
6 Atoms in a box
...
\begin{proof}
    ...
    Then, if the first two electrons occupy the ground state ($n=1$), the third one can only occupy the next state ($n=2$). In this case, the total energy will be $E_{112} = Z^2(E_1+E_1+E_2) = 9(1+1+\frac{1}{2^2})E_1 = \frac{81E_1}{4}$ (where $E_1 = -\frac{m_e e^4}{8\pi^2\epsilon_0^2\hbar^2\rho_0^2} \approx -13.6 $ eV).
